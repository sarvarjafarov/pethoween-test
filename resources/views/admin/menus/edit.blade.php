...
@section('title', 'Edit Menu Item: ' . $menu->name)

@section('content')
<div class="container mx-auto px-4 py-6">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Edit Menu Item: {{ $menu->name }}</h1>
    
    <form action="{{ route('admin.menus.update', $menu) }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-end mt-6">
            ...
            <button type="submit" class="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition duration-300">Update Menu Item</button>
        </div>
    </form>
</div>
@endsection
