                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg p-4">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" name="on_sale" id="on_sale" value="1" {{ old('on_sale', $product->on_sale) ? 'checked' : '' }}
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                        ...
                        <div class="space-y-2 text-sm text-gray-600">
                            ...
                            <div><strong>Created:</strong> {{ $product->created_at->format('M d, Y g:i A') }}</div>
                            <div><strong>Updated:</strong> {{ $product->updated_at->format('M d, Y g:i A') }}</div>
                        </div>
                    </div>
