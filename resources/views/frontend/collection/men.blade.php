...
@section('description', 'Discover our premium men\'s fashion collection')

@section('content')
<x-page-header 
    title="Men's Collection" 
    subtitle="Discover our premium men's fashion collection"
            ...
            <div class="lg:w-3/4">
                <div class="flex justify-between items-center mb-8">
                    <div class="flex items-center space-x-4">
                        <span class="text-gray-600">Showing {{ $products->count() }} men's products</span>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    @empty
                        <div class="col-span-full text-center py-16">
                            ...
                            <h3 class="text-xl font-semibold text-gray-900 mb-2">No Men's Products Found</h3>
                            <p class="text-gray-600 mb-6">We're working on adding amazing men's products to our collection.</p>
...
<section class="py-16 bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-3xl font-bold text-gray-900 mb-4">Stay Updated with Men's Fashion</h2>
        <p class="text-lg text-gray-600 mb-8">Subscribe to our newsletter for the latest men's fashion trends and exclusive offers</p>
